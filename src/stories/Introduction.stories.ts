...
@Component({
  ...
  template: `
    <div class="max-w-4xl mx-auto p-6 font-sans">
      <h1 class="text-4xl font-bold text-gray-900 mb-6">Welcome to ng-shadcn UI Components</h1>
      ...
      <h2 class="text-2xl font-semibold text-gray-800 mb-4">📦 Available Components</h2>
      ...
      <p class="text-gray-600 mb-4">Use our CLI tool to add components to your Angular project:</p>
...
ng-shadcn add button</code></pre>
      ...
      <p class="text-gray-600 mb-4">Each component includes:</p>
      ...
      <h2 class="text-2xl font-semibold text-gray-800 mb-4">🎨 Theming</h2>
      <p class="text-gray-600 mb-4">All components support:</p>
      <ul class="text-gray-600 mb-8 space-y-1">
      ...
      <h2 class="text-2xl font-semibold text-gray-800 mb-4">🧪 Testing</h2>
      <p class="text-gray-600 mb-4">The library includes:</p>
      <ul class="text-gray-600 mb-8 space-y-1">
